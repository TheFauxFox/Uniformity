...
public class TechnoPig<T extends Entity & Saddleable, M extends EntityModel<T>> extends FeatureRenderer<T, M> {

    private final Identifier TEXTURE;
    private final M model;

    public TechnoPig(FeatureRendererContext<T, M> context, M model, Identifier texture) {
        super(context);
